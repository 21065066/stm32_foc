...
| 0x50     | 控制类型                    | 0/1/2/3/4 或是其他可分|           |
| 0x51     | 目标角度                    | °度    |                         |
| 0x52     | 目标速度                    | 弧度/s  |                         |
| 0x53     | 目标转矩 D轴 百分比强度      |   无   |                         |
| 0x53     | 目标转矩 Q轴 百分比强度      |   无   |                         |
...
| 0x60     | U相电流                     | A   |                         |
| 0x61     | V相电流                    | A |                         |
| 0x62     | D轴电流(经过Park变换后的直轴电流)(励磁分量)      |   A   |                         |
| 0x63     | Q轴电流(经过Park变换后的交轴电流(转矩分量))      |   A   |                         |
| 0x64     | 电机转速                    | 弧度/s  |                         |
| 0x65     | 电机多圈角度                    | 弧度    |                         |
| 0x66     | 编码器直接读出的角度      |   弧度   |                         |
| 0x67     | 刚上电时编码器角度      |   弧度   |                         |
| 0x68     | 转子d轴与基础矢量1重合时的编码器角度      |   弧度   |                         |
